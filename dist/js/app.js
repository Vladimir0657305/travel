 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main__slider")) swiper = new core(".main__slider", {
        ...
        document.querySelector(".themetoogle").addEventListener("click", (event => {
            ...
            if ("dark" === localStorage.getItem("theme")) localStorage.removeItem("theme"); else localStorage.setItem("theme", "dark");
            addDarkClassToHTML();
        }));
        ...
        var c, currentScrollTop = 0, menu = document.querySelector(".header");
        ...
        if (animItems.length > 0) {
            ...
            function animOnScroll() {
                for (let index = 0; index < animItems.length; index++) {
                    ...
                    if (window.pageYOffset > animItemOffset - animItemPoint && window.pageYOffset < animItemOffset + animItemHeight) animItem.classList.add("_activetextmain"); else if (!animItem.classList.contains("_anim-no-hide")) animItem.classList.remove("_activetextmain");
                }
            }
            function offset(el) {
